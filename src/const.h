...
constexpr double ka = 0.5 * 1e5; // [1/(L^2*T^2)] area stiffness per vertex mass // default 1e5
...
constexpr double kr = 1e6; // [1/T^2] repulsion stiffness per vertex mass // default 1e7
constexpr double kh = 1e5; // [1/T^2] adhesion stiffness per vertex mass // default 1e6
...
const std::vector<double> k_CV = {0.1}; // [-] reaction coefficients CV
const std::vector<double> D0 = {8}; // [L^2/T] diffusion coefficient background
const std::vector<double> D_mu = {8}; // [L^2/T] diffusion coefficient mean
const std::vector<double> D_CV = {0.1}; // [-] coefficient of variation of diffusion
const std::vector<double> p0 = {0}; // [1/(L^2*T)] production rate background (should be zero)
const std::vector<double> p_mu = {1.0}; // [1/(L^2*T)] production rate mean. Note: mu must be strictly positive. 
const std::vector<double> p_CV = {0.1}; // [-] coefficient of variation of production rate
