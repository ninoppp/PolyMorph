...
const std::vector<double> k_mu = {1.0}; // [?] reaction coefficients mean
const std::vector<double> k_CV = {0.1}; // [-] reaction coefficients CV
const std::vector<double> D0 = {16}; // [L^2/T] diffusion coefficient background
const std::vector<double> D_mu = {16}; // [L^2/T] diffusion coefficient mean
...
const std::vector<double> p_mu = {1}; // [1/(L^2*T)] production rate mean. Note: mu must be strictly positive. 
const std::vector<double> p_CV = {0.3}; // [-] coefficient of variation of production rate
const std::vector<double> threshold_mu = {0.5}; // [1/L^2] concentration threshold mean
