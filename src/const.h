...
const std::vector<double> k_mu = {0.1/100, 0.9/100, 8}; // [?] reaction coefficients mean
...
const std::vector<double> D_mu = {1.0/100, 1.0/100}; // [L^2/T] diffusion coefficient mean
...
const std::vector<double> threshold_mu = {0, 0}; // [1/L^2] concentration threshold mean
