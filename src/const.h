...
const std::vector<double> D0 = {2}; // [L^2/T] diffusion coefficient background
const std::vector<double> D_mu = {2}; // [L^2/T] diffusion coefficient mean
...
const std::vector<double> chemotaxis_strength = {0};
