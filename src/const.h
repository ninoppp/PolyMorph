...
constexpr double alpha_mu = 0.5; // [L^2/T] mean area growth rate // default 1
...
const std::vector<double> k0 =   {0.1, 0.9, 800}; // [?] reaction coefficients background
...
const std::vector<double> D0 =   {1, 8}; // [L^2/T] diffusion coefficient background
const std::vector<double> D_mu = {1, 8}; // [L^2/T] diffusion coefficient mean
