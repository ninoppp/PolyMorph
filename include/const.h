...
constexpr double sh = 0; // [L] adhesion hardening zone size
constexpr double ss = 0; // [L] adhesion softening zone size
...
constexpr bool CHEMOTAXIS = false; // enable chemotaxis. slightly performance enhancing if disabled
