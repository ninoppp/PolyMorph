...
constexpr double alpha_CV = 0.1; // [-] coefficient of variation of area growth rate // default 0
...
constexpr double Amax_CV = 0.1; // [-] coefficient of variation of maximum area // default 0
constexpr double gam = 1e4; //1e4; // [L/T^2] line tension per vertex mass
constexpr double ka = 1e7; //1e5; // [1/(L^2*T^2)] area stiffness per vertex mass // default 1e5
...
constexpr double kh = 1e2; // [1/T^2] adhesion stiffness per vertex mass // default 1e6
...
const std::vector<double> D_CV = {0}; // [-] coefficient of variation of diffusion
...
const std::vector<double> p_CV = {0}; // [-] coefficient of variation of production rate
const std::vector<double> threshold_mu = {0.001}; // [1/L^2] concentration threshold mean. If using multiple readouts, use declining order 
const std::vector<double> threshold_CV = {0.0}; // [-] coefficient of variation of threshold
constexpr double dist_cutoff_factor = 2.0; // [-] lognormal dists are cutoff at mu*factor to maintain stability. only used for D atm.
constexpr double velocity_cutoff_radius = 4.0; // [L] radius for IDW interpolation of velocity field

const std::vector<double> chemotaxis_strength = {1e5}; // force per concentration gradient
